...
var empty = {
    ...
    Status: 'Procured', AssetType: undefined, Country: 'IN', OfficeCode: 'CHN',
};
        ...
        React.createElement("div", { className: styles.form },
            React.createElement("div", { className: styles.section },
                ...
                React.createElement(Stack, { horizontal: true, tokens: { childrenGap: 16 }, wrap: true },
                    ...
                    React.createElement(Stack.Item, { grow: true, styles: { root: { minWidth: 120 } } },
                        React.createElement(TextField, { label: "Country Code *", value: form.Country || '', onChange: function (_e, v) { return set('Country', v === null || v === void 0 ? void 0 : v.toUpperCase()); }, maxLength: 5, errorMessage: errors.Country, disabled: isEdit })),
                    React.createElement(Stack.Item, { grow: true, styles: { root: { minWidth: 120 } } },
                        React.createElement(TextField, { label: "Office Code *", value: form.OfficeCode || '', onChange: function (_e, v) { return set('OfficeCode', v === null || v === void 0 ? void 0 : v.toUpperCase()); }, maxLength: 5, errorMessage: errors.OfficeCode, disabled: isEdit })))),
            React.createElement("div", { className: styles.section },
                React.createElement("div", { className: styles.sectionTitle },
