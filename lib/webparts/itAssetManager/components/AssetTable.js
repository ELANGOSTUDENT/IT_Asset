    ...
    return (React.createElement("div", { className: styles.root },
        ...
        React.createElement("div", { className: styles.resultCount },
            ...
            React.createElement(Text, { variant: "small" },
                ...
                assets.length,
                " assets")),
        filtered.length === 0 && !loading ? (React.createElement(Stack, { horizontalAlign: "center", className: styles.empty },
            React.createElement(Icon, { iconName: "Inbox", className: styles.emptyIcon }),
            React.createElement(Text, null,
                "No assets found. ",
                assets.length === 0 ? 'Click "Add Asset" to get started.' : 'Try adjusting your filters.'))) : (React.createElement(DetailsList, { items: filtered, columns: columns, layoutMode: DetailsListLayoutMode.justified, selectionMode: SelectionMode.none, compact: true, className: styles.list }))));
};
