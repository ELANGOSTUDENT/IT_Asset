...
var ItAssetManager = function (props) {
    ...
    // Build services once
    var sp = useMemo(function () { return spfi().using(SPFx(props.context)); }, [props.context]);
    var siteRelUrl = props.context.pageContext.web.serverRelativeUrl;
    var svc = useMemo(function () { return new AssetService(props.context); }, [props.context]);
    ...
    return (React.createElement("div", { className: styles.root },
        ...
        view === 'dashboard' && (React.createElement(Dashboard, { assets: assets, assetService: svc, onViewAll: function () { setView('list'); setPivotKey('list'); }, onViewAsset: openDetail })),
        view === 'list' && (React.createElement(AssetTable, { assets: assets, loading: loading, onAddNew: function () { return setView('add'); }, onView: openDetail, onEdit: openEdit, onRefresh: loadAssets })),
        ...
        view === 'edit-assign' && selected && (React.createElement(AssetAssignmentForm, { asset: selected, assignmentService: assignSvc, onSave: handleSaveAssignment, onCancel: function () { return setView('detail'); } })),
        view === 'detail' && selected && (React.createElement(AssetDetail, { asset: selected, assetService: svc, repairService: repairSvc, assignmentService: assignSvc, currentUser: props.userDisplayName, onBack: backToList, onEdit: function () { return openEdit(selected); }, onEditAssignment: openEditAssignment, onStatusChange: handleStatusChange })),
