...
var ItAssetManager = function (props) {
    ...
    return (React.createElement("div", { className: styles.root },
        ...
        view === 'detail' && selected && (React.createElement(AssetDetail, { asset: selected, assetService: svc, repairService: repairSvc, assignmentService: assignSvc, fileService: fileSvc, currentUser: props.userDisplayName, onBack: backToList, onEdit: function () { return openEdit(selected); }, onEditAssignment: openEditAssignment, onStatusChange: handleStatusChange })),
