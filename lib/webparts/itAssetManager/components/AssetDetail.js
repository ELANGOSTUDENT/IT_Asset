...
var AssetDetail = function (_a) {
    var asset = _a.asset, assetService = _a.assetService, repairService = _a.repairService, assignmentService = _a.assignmentService, fileService = _a.fileService, currentUser = _a.currentUser, onBack = _a.onBack, onEdit = _a.onEdit, onEditAssignment = _a.onEditAssignment, onStatusChange = _a.onStatusChange;
    ...
    return (React.createElement("div", { className: styles.root },
        ...
        React.createElement("div", { className: styles.body },
            ...
            React.createElement("div", { className: styles.rightPanel },
                ...
                React.createElement(AssetAttachmentSection, { assetId: asset.Title, fileService: fileService }),
                        ...
                        return (React.createElement("div", { key: (_a = h.Id) !== null && _a !== void 0 ? _a : i, className: styles.timelineItem },
                            ...
                            React.createElement("div", { className: styles.timelineContent },
                                React.createElement("div", { className: styles.timelineAction }, h.Action === 'StatusChanged'
                                    ...
                                    : React.createElement("strong", null, h.Action || 'Updated')),
