...
import { ASSET_STATUS_TRANSITIONS, STATUS_BADGE_COLORS, ASSET_TYPE_LABELS, } from '../models/IAsset';
        ...
        React.createElement(Dialog, { hidden: !showStatusDlg, onDismiss: resetStatusDialog, dialogContentProps: { type: DialogType.normal, title: 'Change Asset Status' }, modalProps: { isBlocking: false }, styles: { main: {
            ...
            React.createElement("div", { style: { display: 'flex', flexDirection: 'column', gap: 14, paddingTop: 8, maxHeight: '72vh', overflowY: 'auto', paddingRight: 4 } },
                ...
                (newStatus === 'Scrapped' || (newStatus === 'Disposed' && !scrap)) && (React.createElement("div", { style: { borderTop: '1px solid #e1dfdd', paddingTop: 12, display: 'flex', flexDirection: 'column', gap: 10 } },
                    React.createElement("span", { style: { fontWeight: 700, fontSize: 11, color: '#605e5c', textTransform: 'uppercase', letterSpacing: '0.07em' } }, "Scrap / Disposal Details"),
                    React.createElement("div", { style: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, alignItems: 'start' } },
                        ...
                        React.createElement(TextField, { label: "Scrap Vendor", value: scrapDraftSt.ScrapVendor || '', onChange: function (_e, v) { return setScrapDraftSt(function (d) { return (__assign(__assign({}, d), { ScrapVendor: v || '' })); }); } }),
                        React.createElement(TextField, { label: "Scrap Amount (INR)", type: "number", prefix: "\u20B9", value: scrapDraftSt.ScrapAmount != null ? String(scrapDraftSt.ScrapAmount) : '', onChange: function (_e, v) { return setScrapDraftSt(function (d) { return (__assign(__assign({}, d), { ScrapAmount: v ? parseFloat(v) : undefined })); }); } }),
                        React.createElement(TextField, { label: "Scrap Remarks", value: scrapDraftSt.ScrapRemarks || '', onChange: function (_e, v) { return setScrapDraftSt(function (d) { return (__assign(__assign({}, d), { ScrapRemarks: v || '' })); }); } })),
                    React.createElement("div", null,
                        React.createElement("label", { style: { fontWeight: 600, fontSize: 14, display: 'block', marginBottom: 4 } }, "Certificate / Document"),
