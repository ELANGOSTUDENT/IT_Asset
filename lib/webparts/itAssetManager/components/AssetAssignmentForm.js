...
var AssetAssignmentForm = function (_a) {
    ...
    var _c = useState(existingAssignment
        ? __assign({}, existingAssignment) : emptyAssignment(asset.Title, (_b = asset.Id) !== null && _b !== void 0 ? _b : 0, asset.SerialNumber)), form = _c[0], setForm = _c[1];
    ...
    useEffect(function () {
        if (!isEdit)
            setForm(function (f) { return (__assign(__assign({}, f), { SerialNumber: asset.SerialNumber, Title: asset.Title })); });
        ...
        React.createElement("div", { className: styles.form },
            ...
            React.createElement(Section, { title: "Assignment Details", icon: React.createElement(PersonRegular, null) },
                React.createElement("div", { className: styles.grid },
                    React.createElement(TextField, { label: "Assigned To *", value: form.AssignedTo, onChange: function (_e, v) { return set('AssignedTo', v || ''); }, placeholder: "Full name", errorMessage: errors.AssignedTo }),
                    React.createElement(TextField, { label: "Email *", type: "email", value: form.AssignedToEmail, onChange: function (_e, v) { return set('AssignedToEmail', v || ''); }, placeholder: "user@zoomrx.com", errorMessage: errors.AssignedToEmail }),
            ...
            React.createElement(Section, { title: "Maintenance Schedule", icon: React.createElement(CalendarRegular, null) },
                React.createElement("div", { className: styles.grid },
                    ...
                    React.createElement(TextField, { label: "Maintenance Notes", className: styles.fullWidth, multiline: true, rows: 3, value: form.MaintenanceNotes || '', onChange: function (_e, v) { return set('MaintenanceNotes', v || ''); }, placeholder: "Maintenance schedule, service intervals, AMC details\u2026", maxLength: 2000 }))),
            React.createElement(Section, { title: "Remarks", icon: React.createElement(NoteRegular, null) },
                React.createElement(TextField, { multiline: true, rows: 2, value: form.AssignmentRemarks || '', onChange: function (_e, v) { return set('AssignmentRemarks', v || ''); }, placeholder: "Any notes about this assignment\u2026", maxLength: 1000 }))),
