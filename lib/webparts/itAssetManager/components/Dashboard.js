...
var Dashboard = function (_a) {
    ...
    return (React.createElement("div", { className: styles.root },
        React.createElement("div", { className: styles.kpiRow },
            React.createElement("div", { className: styles.kpiCard, style: { borderTop: '4px solid #0078d4' } },
                React.createElement("div", { className: styles.kpiIconWrap, style: { background: 'rgba(0,120,212,.10)' } },
                    React.createElement(Icon, { iconName: "PC1", style: { color: '#0078d4', fontSize: 18 } })),
            ...
            React.createElement("div", { className: styles.kpiCard, style: { borderTop: '4px solid #ca5010' } },
                React.createElement("div", { className: styles.kpiIconWrap, style: { background: 'rgba(202,80,16,.10)' } },
                    React.createElement(Icon, { iconName: "Warning", style: { color: '#ca5010', fontSize: 18 } })),
        ...
        React.createElement(Stack, { horizontal: true, tokens: { childrenGap: 24 }, className: styles.panels },
