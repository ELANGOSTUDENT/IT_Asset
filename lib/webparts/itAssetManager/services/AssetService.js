...
var AssetService = /** @class */ (function () {
    ...
    AssetService.prototype.getNextSequenceNumber = function (type, country, office) {
        return __awaiter(this, void 0, void 0, function () {
            var prefix, items;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        prefix = AssetIdGenerator.getPrefix(type, country, office);
                        return [4 /*yield*/, this._sp.web.lists
                                .getByTitle(ASSETS_LIST)
                                .items.filter("startswith(Title,'".concat(prefix, "')"))
                    ...
                    case 1:
                        ...
                        if (!items.length)
                            return [2 /*return*/, 1];
                        return [2 /*return*/, (items[0].SequenceNumber || 0) + 1];
                }
            });
        });
    };
    AssetService.prototype.addAsset = function (asset) {
        return __awaiter(this, void 0, void 0, function () {
            var seq, assetId, payload, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getNextSequenceNumber(asset.AssetType, asset.Country, asset.OfficeCode)];
                    case 1:
                        seq = _a.sent();
                    ...
                    case 3:
                        _a.sent();
                        return [2 /*return*/, __assign(__assign({}, payload), { Id: result.data.Id })];
                }
            });
        });
    };
    AssetService.prototype.updateAsset = function (id, changes) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._sp.web.lists.getByTitle(ASSETS_LIST).items.getById(id).update(changes)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    AssetService.prototype.changeStatus = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var assetId, itemId, previousStatus, newStatus, notes, changedBy, changedByEmail, extraFields;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        assetId = params.assetId, itemId = params.itemId, previousStatus = params.previousStatus, newStatus = params.newStatus, notes = params.notes, changedBy = params.changedBy, changedByEmail = params.changedByEmail, extraFields = params.extraFields;
    ...
    AssetService.prototype.getRecentHistory = function (limit) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this._sp.web.lists.getByTitle(HISTORY_LIST)
